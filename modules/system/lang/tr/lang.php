...
return [
    ...
    'plugins' => [
        ...
        'enable_or_disable' => 'Aktif / Pasif',
        'enable_or_disable_title' => 'Eklentileri aktifleştir / pasifleştir',
        'remove' => 'Kaldır',
        'refresh' => 'Yenile',
        'disabled_label' => 'Pasif',
        'disabled_help' => 'Plugins that are disabled are ignored by the application.',
        'selected_amount' => 'Seçili eklentiler: :amount',
        'remove_success' => "Eklenti(ler) başarılı bir şekilde kaldırıldı.",
        'refresh_success' => "Eklenti(ler) başarılı bir şekilde yenilendi.",
        'disable_success' => "Eklenti(ler) başarılı bir şekilde pasifleştirildi.",
        'enable_success' => "Eklenti(ler) başarılı bir şekilde aktifleştirildi.",
    ],
    'project' => [
        'name' => 'Proje',
        'owner_label' => 'Sahibi',
