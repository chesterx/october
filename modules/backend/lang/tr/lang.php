...
return [
    ...
    'user' => [
        ...
        'return' => 'Yönetici listesine geri dön.',
        'group' => [
            'name' => 'Grup',
            'name_field' => 'Adı',
            'menu_label' => 'Gruplar',
            'list_title' => 'Grupları Yönet',
            'new' => 'Yönetim grubu oluştur',
            'delete_confirm' => 'Bu yönetim grubunu silmek istediğinize emin misiniz?',
            'return' => 'Yönetim grubu listesine geri dön',
        ],
        'preferences' => [
